...
const BookService = require('../../src/services/bookServices');
  ...
  describe('#getById', () => {
    ...
    describe('quando existe o livro', () => {
      before(async () => {
        ...
        book = await BookService.getAllBooksbyId(1);
      });
    ...
    describe('quando não existe o livro', () => {
      before(async () => {
        ...
        book = await BookService.getAllBooksbyId(1000);
      });
  ...
  describe('#create', () => {
    describe('retorna o registro do livro criado', () => {
      ...
      before(async () => {
        ...
        book = await BookService.createBooks(testBook);
      });
  ...
  describe('#update', () => {
    ...
    describe('quando existe o livro', () => {
      before(async () => {
        ...
        updated = await BookService.updateBooks(2, testBook)
      });
    ...
    describe('quando não existe o livro', () => {
      before(async () => {
        ...
        updated = await BookService.updateBooks(1000, testBook)
      });
  ...
  describe('#remove', () => {
    ...
    describe('quando existe o livro', () => {
      before(async () => {
        ...
        removed = await BookService.deleteBooks(2);
      });
    ...
    describe('quando não existe o livro', () => {
      before(async () => {
        ...
        updated = await BookService.deleteBooks(1000)
      });
